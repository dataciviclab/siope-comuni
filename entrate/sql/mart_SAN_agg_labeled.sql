...
select
    ...
    case
        when a.codice_voce like '1.01.%' then 'Imposte proprie'
        when a.codice_voce like '1.03.%' then 'Fondi perequativi'
        when a.codice_voce like '2.01.%' then 'Trasferimenti correnti'
        when a.codice_voce like '4.02.%' then 'Contributi agli investimenti'
        else 'Altro'
